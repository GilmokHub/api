package kr.gilmok.platform.queue.scheduler;
...
public class AdmissionScheduler {
    ...
    public void processAdmission() {
                java.util.Set<String> openEvents = queueRedisRepository.getActiveQueueIds();
        boolean anySuccess = false;

        for (String eventIdStr : openEvents) {
            String eventId = eventIdStr;
            Long eventIdLong;
            try {
            ...
            try {
                ...
                Optional<PolicyCacheDto> policyOpt = policyCacheRepository.find(eventIdLong);
