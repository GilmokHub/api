package kr.gilmok.platform.policy.service;

import kr.gilmok.platform.policy.constants.PolicyDefaults;
import kr.gilmok.platform.policy.dto.PolicyCacheDto;
import kr.gilmok.platform.policy.dto.PolicyCreateRequest;
...
import kr.gilmok.platform.policy.entity.PolicyHistory;
import kr.gilmok.platform.policy.exception.PolicyErrorCode;
import kr.gilmok.platform.policy.repository.PolicyCacheRepository;
import kr.gilmok.platform.policy.repository.PolicyHistoryRepository;
import kr.gilmok.platform.policy.repository.PolicyRepository;
import kr.gilmok.platform.policy.validation.BlockRulesValidator;
